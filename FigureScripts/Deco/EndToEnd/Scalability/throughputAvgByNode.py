...
fig.add_trace(go.Bar(name="Root-Input", x=["Root-Input"], y=[6015109.39], legendrank=1, width=[0.8]
                     , text="6.02M", textposition='outside', textfont = dict(size = 30)
...
fig.update_layout(
    ...
    xaxis=dict(
        ...
        ticktext=[ "Local-Input", "Local-Onput", "Root-Input"],
        # tickvals=[1, 2, 3, 4],
        tickmode="array",
        # range=[0, 6],
    ),
...
pio.write_image(fig, "E:\On going Paper\Deco Efficient Decentralized Aggregation for Count-Based Windows\experiment\s1\/scalability\ThroughputNodes.pdf")
pio.write_image(fig, "E:\On going Paper\Deco Efficient Decentralized Aggregation for Count-Based Windows\experiment\s1\/scalability\ThroughputNodes.svg")
