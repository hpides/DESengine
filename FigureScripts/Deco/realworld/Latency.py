...
fig.add_trace(go.Bar(name="Central", x=["Central"], y=[251], legendrank=1, width=[0.8]
                     , text="251"
                     , textposition='outside', textfont = dict(size = 35)
                     , marker_color=config.central, marker_pattern_shape="/"))
fig.add_trace(go.Bar(name="Disco", x=["Disco"], y=[1.3216187], legendrank=2, width=[0.8]
                     , text="1.321"
                     , textposition='outside', textfont = dict(size = 35)
                     , marker_color=config.disco, marker_pattern_shape="."))
fig.add_trace(go.Bar(name="Scotty", x=["Scotty"], y=[0.616244], legendrank=3, width=[0.8]
                     , text="0.616"
                     , textposition='outside', textfont = dict(size = 35)
                     , marker_color=config.scotty, marker_pattern_shape="x"))
fig.add_trace(go.Bar(name="DecoAsy", x=["Deco<sub>async</sub>"], y=[0.424096], legendrank=4, width=[0.8]
                     , text="0.424"
                     , textposition='outside', textfont = dict(size = 35)
...
pio.write_image(fig, "E:\On going Paper\Deco Efficient Decentralized Aggregation for Count-Based Windows\experiment\s3\/rsLatencyOverall.pdf")
pio.write_image(fig, "E:\On going Paper\Deco Efficient Decentralized Aggregation for Count-Based Windows\experiment\s3\/rsLatencyOverall.svg")
