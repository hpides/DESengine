...
fig.add_trace(go.Bar(name="Local", x=windowType, y=[0, 0, 600179, 116681]
...
fig.add_trace(go.Bar(name="Intermediate", x=windowType, y=[0, 0, 11012987, 6018705]
                     , legendrank=2, width=widthAll
                     , marker_line_width=0, marker_color=config.disco))
fig.add_trace(go.Bar(name="Root", x=windowType, y=[28000000, 5601264, 6195624, 5464357]
                     , legendrank=2, width=widthAll
...
fig.update_layout(
    ...
    yaxis=dict(
        ...
        ticktext=["4", "8", "12", "16", "20", "...", "420"],
        tickvals=[4000000, 8000000, 12000000, 16000000, 20000000, 24000000, 28000000],
        tickmode="array",
        range=[0, 28200000],
...
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s1\/latency\/latencym.pdf")
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s1\/latency\/latencym.svg")