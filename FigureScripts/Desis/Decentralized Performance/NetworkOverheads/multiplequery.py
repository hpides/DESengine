...
fig.add_trace(go.Scatter(name="Desis", x=xdata, mode='lines+markers'
                         , y=[464, 2320, 2320, 2320, 2320, 2320]
...
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s1\/networkoverhead\/networkoverheadMultiplequery.pdf")
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s1\/networkoverhead\/networkoverheadMultiplequery.svg")