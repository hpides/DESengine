...
fig.add_trace(go.Scatter(name="local", x=[1, 2, 4, 10, 50, 100, 1000], mode='lines+markers'
                         , y=[30801883.73, 29210000, 28168133.35, 26495495.04, 23751398.76, 17942148.97, 16484829.2]
...
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s1\/scalability\ThroughputAverageMultipleKeys.pdf")
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s1\/scalability\ThroughputAverageMultipleKeys.svg")