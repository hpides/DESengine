...
fig.add_trace(go.Scatter(name=systemType[0], x=[2, 10, 50, 100, 500, 1000], mode='lines+markers'
                         , y=[2000000, 10000000, 50000000, 100000000, 500000000, 1000000000]
...
fig.add_trace(go.Scatter(name=systemType[3], x=[2, 10, 50, 100, 500, 1000], mode='lines+markers'
                         , y=[1000000, 1000000, 1000000, 1000000, 1000000, 1000000]
...
fig.update_layout(
    ...
    yaxis=dict(
        ...
        exponentformat="e",
        # ticktext=["0", "5M", "10M", "15M", "20M", "25M", "30M", "1B"],
        # tickvals=[0, 5000000, 10000000, 15000000, 20000000, 25000000, 30000000, 1000000000],
        # tickmode="array",
        # range=[0, 1010000000],
...
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s2\shareFunction\/quantilequantileCal.pdf")
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s2\shareFunction\/quantilequantileCal.svg")