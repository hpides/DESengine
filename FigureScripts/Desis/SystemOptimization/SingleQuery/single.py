...
windowType = ['Median', 'Quantile', 'Average', 'Sum', 'Count', 'Max', 'Min', "",
              'Tumbling', 'Sliding', 'User-defined', 'Session', 'Countbased']
widthSin = 0.2
widthAll=[widthSin,widthSin,widthSin,widthSin,widthSin,widthSin,widthSin, 0.0,
            widthSin,widthSin,widthSin,widthSin,widthSin]

fig = go.Figure()

fig.add_trace(go.Bar(name="DeBuffer", x=windowType, y=[1520597.885, 1557800.284, 3495378.13, 3359127.763, 3341792.98, 3392249.027, 3355436.95, 0,
                    3372245.47, 1966341.8, 2238047.26, 2041280.4, 2181275.89]
                     , legendrank=1, width=widthAll
                     , marker_color=config.central))
fig.add_trace(go.Bar(name="DeBucket", x=windowType, y=[7231345.29, 7230599.76, 32348346.87, 31675630.53, 32917038.1, 33999379.84, 33600584.11, 0,
                    31256010.27, 31687829.55, 30392116.51, 30565557.23, 29103915.63]
                     , legendrank=2, width=widthAll
                     , marker_color=config.desisIC))
fig.add_trace(go.Bar(name="DeSW", x=windowType, y=[7124119.39, 7298107.12, 31171516.62, 31651978.27, 32811652.63, 33526088.52, 33681575.7, 0,
                    31572287.21, 31566440.19, 30735626.13, 30871344.42, 29466985.84]
                     , legendrank=3, width=widthAll
                     , marker_color=config.desisSW))
fig.add_trace(go.Bar(name="Desis", x=windowType, y=[7401292, 7345260.74, 32429281.64, 33303603.04, 33626397.4, 34126237.66, 34166162.26, 0,
                    32743863.48, 31710032.11, 30776051.23, 30929431.42, 29624994.05]
