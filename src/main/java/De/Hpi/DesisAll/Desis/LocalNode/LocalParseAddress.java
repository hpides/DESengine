...
public class LocalParseAddress {
    ...
    public static String getLocalPubAddress(Configuration configurationTopology, int nodeId){
        if(configurationTopology.RASBERRYPI == true){
            switch(nodeId){
                case 1:
                    return configurationTopology.localPubAddr1R;
                case 2:
                    return configurationTopology.localPubAddr2R;
                case 3:
                    return configurationTopology.localPubAddr3R;
                default:
                    return configurationTopology.localPubAddr4R;
            }
        }
