...
import De.Hpi.DesisAll.DesisIC.Dao.*;
...
public class OptimizerCount {
    ...
    public long previousCountCounter;
...
//        if(tupleCounter - previousCountCounter >= conf.countgranularity || timeTemp - previousTimeCounter >= conf. timegranularity){
            //slice window
...
//        if(localWindows.size() == 0) {
            ...
            windowCollection.sliceId = (int) (System.nanoTime() - latencyStart);
            System.out.println(System.nanoTime() - latencyStart);
