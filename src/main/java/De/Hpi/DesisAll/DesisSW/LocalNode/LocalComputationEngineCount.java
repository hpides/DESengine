package De.Hpi.DesisAll.DesisSW.LocalNode;

import De.Hpi.DesisAll.DesisSW.Configure.Configuration;
import De.Hpi.DesisAll.DesisSW.Dao.*;

import java.util.ArrayList;
import java.util.concurrent.ConcurrentLinkedQueue;

public class LocalComputationEngineCount implements Runnable{

    private ArrayList<OptimizerCount> optimizers;
    ...
    public LocalComputationEngineCount(Configuration conf, ConcurrentLinkedQueue<WindowCollection> intermediateResultQueue,
    ...
    public void queryPreProcess(){
        ...
        while(queryCounter < conf.queryNumber){
            if(!queryQueue.isEmpty()) {
                ...
                queryCounter++;
                OptimizerCount optimizerTemp = optimizers.stream()
                        .filter(optimizer -> {
                ...
                OptimizerCount optimizer = new OptimizerCount(conf, intermediateResultQueue, query.getFunction(), query.getScenario());
