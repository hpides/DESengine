...
//                Object value = DistributedUtils.bytesToObject(receiver.recv(ZMQ.DONTWAIT));
        ...
        for (int i = 0; i < numParallelSockets; i++) {
            ...
            Socket receiver = zContext.createSocket(SocketType.PULL);
            ...
            Socket sender = zContext.createSocket(SocketType.PUSH);
    ...
    private void setupNetworkPullRun() throws IOException {
        Consumer<Socket> push = (eventSender) -> {
            try {
                Thread.sleep(1000);
