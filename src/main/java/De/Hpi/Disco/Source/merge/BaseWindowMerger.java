...
import De.Hpi.Disco.Source.aggregation.WindowFunctionKey;
...
public abstract class BaseWindowMerger<AggType> implements WindowMerger<AggType> {
    ...
    private Optional<FunctionWindowAggregateId> getSessionStartFromChildStarts(WindowFunctionKey windowKey) {
        ...
        FunctionWindowAggregateId minNewSessionId = new FunctionWindowAggregateId(windowId, 0, FunctionWindowAggregateId.NO_CHILD_ID, key);
