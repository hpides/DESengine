...
//    public int countgranularity = 10000;
    ...
    public static final boolean DEBUGMODE_GENERATOR = true;
    public static final boolean DEBUGMODE_PRINTER = false;
    //windows & Linuxs
    ...
    public int eventRatesChangingRange = 1;
    ...
    //how many windows for initialization step
    public int InitializationSteps = 10;
