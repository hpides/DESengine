package De.Hpi.DemaAll.Dema.LocalNode;

import De.Hpi.DemaAll.Dema.Configure.Configuration;
import De.Hpi.DemaAll.Dema.Dao.LocalWindow;
import De.Hpi.DemaAll.Dema.Dao.LocalisEventHere;
import De.Hpi.DemaAll.Dema.Dao.Query;
import De.Hpi.DemaAll.Dema.Dao.Tuple;
import De.Hpi.DemaAll.Dema.Generator.InputStream;
import De.Hpi.DemaAll.Dema.Message.MessageToLocal;
import De.Hpi.DemaAll.Dema.Message.MessageToRoot;
...
public class OptimizerMedian implements Runnable{
...
//    private long deltaSize;
    ...
    public OptimizerMedian(Configuration conf, InputStream inputStream, ConcurrentLinkedQueue<MessageToRoot> messageToRootQueue,
